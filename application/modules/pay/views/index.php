                        ...
                        <div class="list-group shadow-lg p-4 border-rounded">
                            ...
                            <div class="d-flex gap-2 w-100 justify-content-between p-2">
                                ...
                                <div class="ms-2">
                                    ...
                                    <p id="product-description" class="mb-0 opacity-75">Illuminate your workspace with the LuxeGlow LED Desk Lamp. This sleek and modern lamp...</p>
                                </div>
                            ...
                            <img src="<?php echo base_url('assets/images/product2.webp'); ?>" alt="Product Image">
                                <div class="ms-2">
                                    ...
                                    <p id="product-description" class="mb-0 opacity-75">Transform your space into a sanctuary with the ZenVibe Aromatherapy Diffuser...</p>
                                </div>
                            ...
                            <button type="submit" class="btn custom-button mt-4">
